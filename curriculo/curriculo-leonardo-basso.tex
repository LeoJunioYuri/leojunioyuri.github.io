...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Construí do zero o MetaAds — sistema de tráfego pago autônomo com IA para restaurantes. De 0 a 2.000+ atendidos, R\$20M+ em vendas rastreadas e retorno médio de 10$\times$ para nossos clientes.
            \item Arquitetura serverless em TypeScript/Node.js/Vue.js + GCP Cloud Functions, construída do zero com PostgreSQL/AlloyDB, Prisma ORM e Layered Architecture.
            \item Anderson: agente LLM autônomo (GPT-5, reasoning=high) com ciclo semanal de 5 fases, memória vetorial pgvector (1536d), loop de atribuição com ROAS real e 7 guardrails determinísticos.
            \item Camada financeira própria: R\$500k+/mês em verba de clientes gerida via PIX + Meta API, sem operador humano no fluxo.
            \item Observabilidade em produção: PostHog para rollouts sem deploy (feature flags por storeId), Sentry com gauge metrics e Metabase com 150+ cards para decisões de produto e analytics de cohorts.
        \end{highlights}
    \end{onecolentry}
