...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Lidero o MetaAds: sistema end-to-end de tráfego pago automatizado com IA para 2.000+ restaurantes atendidos. R\$20M+ em vendas rastreadas e retorno médio de 10$\times$ sobre o investimento aos nossos clientes.
            ...
            \item PostHog (feature flags por storeId), Sentry (gauge metrics, 10\% trace sampling) e Metabase com 150+ cards de analytics.
        \end{highlights}
    \end{onecolentry}
