...
export const ui = {
  pt: {
    ...
    "life.music.top": "Mais ouvidas de todos os tempos",
    ...
    "life.games.note": "Steam + PC (via Microsoft). Horas na seção abaixo são só Steam.",
  ...
  en: {
    ...
    "life.music.top": "All-time most played",
    ...
    "life.games.note": "Steam + PC (via Microsoft). Hours in the section below are Steam only.",
