...
\begin{document}
    ...
    \vspace{0.2 cm}
    \begin{onecolentry}
        Product Engineer com 4+ anos de experiência, especializado no ponto em que produto, engenharia, IA e escala se encontram. Na Brendi, construí o MetaAds do zero — sistema autônomo de tráfego pago para 2.000+ restaurantes atendidos, com R\$4M+ em mídia gerida, R\$20M+ em vendas rastreadas e retorno médio de 10$\times$ sobre o investimento.
    \end{onecolentry}
